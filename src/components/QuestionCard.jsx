    ...
    <div className="question-card w-full relative">
      ...
      <Link href={"/questions/" + data._id}>
        ...
        <div className=" flex flex-row items-center justify-between mx-2 my-4 p-4 rounded-xl border border-gray-300">
          <div className="col-left px-2">
            <h3 className="text-black py-2">{data.questionTitle}</h3>
            <p className="my-2 text-gray-600">
              {data?.answers?.[0]?.answerContent}
            </p>
            <div className="question-date py-2 text-xs">
    Asked on: <ReadableDateTime isoString={data?.questionDate}/>
            </div>
            <div className="ans-view flex flex-row items-center justify-start">
              <div className="">
